...
@section('content')
    ...
    <section class="no-padding-top">
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="title"><a
                        class="btn btn-primary mr-1 mb-1" href="{{route('week.create')}}">Weeks add</a>
                </div>
...
{{--                                        <a href="{{route('week.edit', $data_c)}}" class="btn btn-primary">Edit</a>--}}
                                        <form class="d-inline" action="{{route('week.destroy', $data_c->id)}}"
                                              method="post">
                                            @csrf
                                            @method('DELETE')
