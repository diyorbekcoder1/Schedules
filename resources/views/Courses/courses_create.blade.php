            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">Courses add </h4>
                    </div>
                    <div class="card-content">
                        <div class="card-body">

                            <form method="post" class="needs-validation" action="{{route('courses.store')}}"
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label for=""></label><select name="facult_id" id=""
                                                ...
                                                <option hidden>Select Facult</option>

                                                @foreach($facult_id as $facult)
