...
<head>
    ...
    <link href="{{asset('newassets/img/logo.png')}}" rel="apple-touch-icon">
...
<main id="main">
    ...
    <!-- ======= Why Us Section ======= -->
    <section style="width: 100%"; id="why-us" class="why-us section-bg">
            ...
            <div class="row">
                ...
                <div
                    ...
                    <div class="content pb-3">
                        <h3 style="font-weight:bold ;">Kursni tanlang</h3>
                    ...
                    <div class="accordion-list">
                        <ul>
                            ...
                            @if(isset($facultCourses))
                                @foreach($facultCourses as $course)
                                    <li>
                                        <a href="{{ route('courseGroups', [$course->facult_id, $course->id]) }}"><span>{{$course->name}}</span></a>
                                    </li>
                ...
                <div class="col-lg-5 align-items-stretch order-1 order-lg-2 img "
                     style='background-image: url("{{asset('newassets/img/intro-img.svg')}}");' data-aos="zoom-in" data-aos-delay="150">
                    &nbsp;
                </div>
            </div>
